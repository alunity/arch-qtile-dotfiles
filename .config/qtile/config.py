...
keys = [
    ...
    Key([mod], "q", lazy.spawn("rofi -show window")),
...
layouts = [
    layout.Columns(border_focus_stack=["#C3B1E1", "#C3B1E1"], border_width=2, border_focus="#C3B1E1"),
    # layout.Max(),
...
screens = [
    Screen(
        bottom=bar.Bar(
            ...
            # border_color=["C3B1E1", "#C3B1E1", "#C3B1E1", "#C3B1E1"]  # Borders are magenta
        ),
